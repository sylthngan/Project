...
class _HouseDetailState extends State<HouseDetail> {
  ...
  List<Map<String, dynamic>> getHouseFacilities(PostModel post) {
    return [
      if (post.kitchen) {"icon": Icons.kitchen, "label": "Kitchen"},
      if (post.wifi) {"icon": Icons.wifi, "label": "Wifi"},
      if (post.parking) {"icon": Icons.garage, "label": "Garage"},
      if (post.balcony) {"icon": Icons.balcony, "label": "Balcony"},
      if (post.securityCamera) {"icon": Icons.security, "label": "Security"},
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Wrap(
                          spacing: 15,
                          runSpacing: 15,
                          children: getHouseFacilities(widget.post)
                              .map((f) => _facility(f["icon"], f["label"]))
                              .toList(),
                        ),
  ...
  Widget _facility(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color:
        colorsyle.textPrimary.withOpacity(0.2),
